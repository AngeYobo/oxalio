-- V9__multi_tenant_architecture.sql (PostgreSQL)
...
CREATE TABLE tenants (
    ...
    fne_establishment VARCHAR(255) DEFAULT 'Siège',
...
('starter', 'Starter', 25000, 50, 1, '{"api_access": false, "priority_support": false, "custom_branding": false}'::jsonb),
('professional', 'Professional', 50000, 500, 3, '{"api_access": true, "priority_support": true, "custom_branding": false}'::jsonb),
('enterprise', 'Enterprise', 150000, 999999, 999, '{"api_access": true, "priority_support": true, "custom_branding": true, "dedicated_support": true}'::jsonb);
...
-- ============================================================
-- 6) Tenant admin (OXALIO) + backfill des anciennes données
-- ============================================================
INSERT INTO tenants (
...
-- Backfill: rattacher l'existant au tenant oxalio-admin (si tables déjà remplies)
UPDATE invoices
...
-- Fin V9__multi_tenant_architecture.sql (PostgreSQL)